...
#     """
#     Example of how to use curvature validation in a workflow.
#     """
#     import curves
#
#     # Define parameters
...
#
#     # Generate curve
#     curve_generator = curves.Curves(doc, {
#         'type': 'sinusoidal',
#         'parameters': params
#     })
#     points = curve_generator.get_curve_points()
#
#     # Validate
#     validation = validate_curve_for_cylinders(
#         points,
#         cylinder_radius,
#         min_radius_factor=4.0
#     )
#
...
#
#         # Or auto-correct
#         corrected_params, new_validation = auto_correct_curve_parameters(
#             'sinusoidal',
#             params,
#             cylinder_radius,
#             generator_func=lambda **p: curve_generator._generate_sinusoidal(**p)
#         )
#
#         print(f"\nAuto-corrected parameters: {corrected_params}")
#         print(new_validation['message'])